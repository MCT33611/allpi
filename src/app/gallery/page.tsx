            ...
            if (folder.type === 'folder' && folder.images.length > 0) {
              return (
                <div key={folder.id} className="w-full max-w-5xl mx-auto">
                  ...
                  <Link href={`/gallery/${folder.name}`} className="block group">
                          ...
                          {folder.images.map((image, index) => (
                            ...
                            >
                              <div className="relative w-full h-full">
                                ...
                                {index === 0 && (
                                  <>
                                    <div className="absolute top-0 right-0 w-0 h-0 border-t-[60px] border-t-accent/80 border-l-[60px] border-l-transparent group-hover:border-t-accent transition-colors z-10"></div>
                                    <div className="absolute top-2.5 right-1.5 text-accent-foreground flex flex-col items-center z-20 pointer-events-none">
